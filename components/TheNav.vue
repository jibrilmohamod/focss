            ...
            <div class="font-jost border-b border-gray-500 flex justify-between rounded-sm text-base">
                ...
                <div class="py-2 border-r border-gray-500 rounded-sm px-5 grow flex justify-center items-center w-fit">
                    ...
                    <Icon name="mdi:instagram"
                          class="text-white grow hover:text-pink-700" />
                    <!-- icon  -->
                    <Icon name="mdi:twitter"
                          class="text-white grow hover:text-sky-600" />
                    <!-- tiktok -->
            ...
            <div class="flex items-center py-5">
                ...
                <h1 class="w-fit">
                    <NuxtLink to="/">
                        <img src="/Logo.svg"
                             alt="logo"
                             class="object-contain h-16 w-fit" />
                    </NuxtLink>
                </h1>
                <!-- navigation -->
                <div class="flex-grow flex justify-end items-center gap-5">
                    ...
                    <div class="flex justify-end items-center gap-5">
                        <a href="mailto:info@focalfoods.co.ke"
        ...
        <div class="md:hidden">
            <NuxtLink to="/">
                ...
                <div class="text-wh border-buttonite absolute z-20 top-5 left-4">
                    <h1 class="h-12 py-2 px-4 text-4xl font-Lexend">
                        <img src="/Logo.svg"
                             alt="logo"
